...
class DialogAssistant:
    ...
    def get_answer(self, user_question,info_base):
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                {"role": "system", 
                 "content": f"""Ничего не придумывай! Ответ давай не более чем 200 слов. Ответ дай на основе базы знаний: {info_base}. Пользуйся историей диалога {history} Ссылки ищи в базе."""},
